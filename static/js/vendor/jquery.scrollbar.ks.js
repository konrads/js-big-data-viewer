...
(function($, doc, win){
    ...
    var defaults = {
        ...
        "scrollXStep": 30,          // scroll step for X scrollbar arrows
        "scrollYStep": 30,          // scroll step for Y scrollbar arrows
    ...
    customScrollbar.prototype = {
        ...
        init: function(options){
            ...
            $.each(s, function(d, scrollx){
                ...
                var scrollStep = (d == "x") ? o.scrollXStep : o.scrollYStep;
                ...
                if(!scrollx.scrollbar){
                    ...
                    .on("mousedown.scrollbar", function(event){
                        ...
                        if($(this).hasClass('scroll-arrow')){
                            ...
                            scrollStep = (d == "x") ? o.scrollXStep : o.scrollYStep;
                            scrollStep = scrollForward ? scrollStep : scrollStep * -1;
